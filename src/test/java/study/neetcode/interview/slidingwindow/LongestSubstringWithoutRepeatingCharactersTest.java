    ...
    static Stream<TestCase> testCases() {
        return Stream.of(
                new TestCase("abcabcbb", 3,
                        "classic case: longest is abc"),

                new TestCase("bbbbb", 1,
                        "all same characters"),

                new TestCase("pwwkew", 3,
                        "longest is wke; pwke is not contiguous"),
                ...
                new TestCase("dvdf", 3,
                        "important trap: longest is vdf"),

                new TestCase("abba", 2,
                        "important trap for left pointer jumping"),

                new TestCase("tmmzuxt", 5,
                        "longest is mzuxt"),

                new TestCase("abcdef", 6,
                        "all unique"),

                new TestCase("abcdea", 5,
                        "repeat of first char at end"),

                new TestCase("aab", 2,
                        "left must move past first a"),

                new TestCase("ohvhjdml", 6,
                        "longest is vhjdml"),

                new TestCase("anviaj", 5,
                        "longest is nviaj")
        );
    }
