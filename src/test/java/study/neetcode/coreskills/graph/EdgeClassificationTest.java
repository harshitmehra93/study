...
public class EdgeClassificationTest {
    ...
    void test_2() {
        ...
        assertEquals(
                EdgeType.BACK_EDGE, dfsTraversal.classification.get(graph.getEdge(1, 3).get()));
        assertEquals(
                EdgeType.TREE_EDGE, dfsTraversal.classification.get(graph.getEdge(1, 2).get()));
        assertEquals(
                EdgeType.TREE_EDGE, dfsTraversal.classification.get(graph.getEdge(3, 5).get()));
        assertEquals(
    ...
    //         * */
    //
    //        Map<UndirectedEdge<Integer>,EdgeType> classification =
    // DfsTraversal.classify(graph,graph.getNode(1));
    ...
    //        assertEquals(EdgeType.TREE_EDGE,classification.get(graph.getEdge(3,5).get()));
    //        assertEquals(EdgeType.CROSS_EDGE,classification.get(graph.getEdge(2,5).get()));
    ...
    //        Map<UndirectedEdge<Integer>,EdgeType> classification =
    // DfsTraversal.classify(graph,graph.getNode(1));
    //        for(UndirectedEdge<Integer> edge : classification.keySet())
    //            System.out.println(edge);
    //        assertEquals(6,classification.keySet().size());
    //    }
    ...
    //        assertEquals(5,classification.keySet().size());
    //        assertEquals(EdgeType.TREE_EDGE,classification.get(graph.getEdge(1,2).get()));
    //        assertEquals(EdgeType.TREE_EDGE,classification.get(graph.getEdge(1,5).get()));
    //        assertEquals(EdgeType.TREE_EDGE,classification.get(graph.getEdge(1,8).get()));
    //        assertEquals(EdgeType.CROSS_EDGE,classification.get(graph.getEdge(4,5).get()));
    //        assertEquals(EdgeType.TREE_EDGE,classification.get(graph.getEdge(2,4).get()));
    //    }
}
