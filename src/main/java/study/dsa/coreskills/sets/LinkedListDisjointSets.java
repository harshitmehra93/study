package study.dsa.coreskills.sets;
...
public class LinkedListDisjointSets<T> extends DisjointSets<T> {
    Map<T, study.dsa.coreskills.sets.Set<T>> elementToSetMap = new HashMap<>();
    List<study.dsa.coreskills.sets.Set<T>> sets = new ArrayList<>();

    @Override
    public study.dsa.coreskills.sets.Set<T> makeSet(T element) {
    ...
    @Override
    public Optional<study.dsa.coreskills.sets.Set<T>> findSet(T a) {
        if (elementToSetMap.containsKey(a)) return Optional.of(elementToSetMap.get(a));
        return Optional.empty();
    }

    @Override
    public study.dsa.coreskills.sets.Set<T> union(
            study.dsa.coreskills.sets.Set<T> setA, study.dsa.coreskills.sets.Set<T> setB) {
