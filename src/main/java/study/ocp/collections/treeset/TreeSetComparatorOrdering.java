package study.ocp.collections.treeset;

import java.util.*;

class TreeSetComparatorOrdering {
    ...
    public static void main(String... args) {
        ...
        Set<Dinosaur> speciesSet =
                new TreeSet<Dinosaur>(Comparator.comparing(Dinosaur::getSpecies));
