...
class Test26{
	public static void main(String... args){
		List<String> a = List.of("   I","aaAAAaa", "","   This","  IS  ","the","  part  ","where","    I","gain"
			,"good","  understanding  ","   of","  Streams  ","  AND  ","ace","  OCP","And   ","my","    career","    becomes","rocket","   AAAA","AAAA","AAaa","BBBB","bbbb");
