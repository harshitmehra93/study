package study.ocp.streams.flattening;
...
class FlattenUniqueTags {
    public static void main(String... args) {
        List<List<String>> a =
                List.of(
                        List.of("His", "palms", "are", "sweaty"),
                        List.of("knees", "weaks", "arms", "are", "heavy"),
                        List.of(
                                "theres",
                                "vommit",
                                "on",
                                ...
                                "but"),
                        List.of(
                                "on", "the", "surface", "he", "looks", "calm", "and", "ready", "to",
                                "drop", "bombs", "but", "he", "keeps"),
