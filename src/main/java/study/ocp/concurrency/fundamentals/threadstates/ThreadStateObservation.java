package study.ocp.concurrency.fundamentals.threadstates;
        ...
        while (true) {
            System.out.println(
                    "State "
                            + t1.getName()
                            + " = "
                            + t1.getState()); // RUNNABLE/Terminated/Blocked/TIMED_WAITING
            System.out.println(
                    "State "
                            + t2.getName()
                            + " = "
                            + t2.getState()); // RUNNABLE/Terminated/Blocked/TIMED_WAITING
            Thread.sleep(2000);
        }
    }
}
