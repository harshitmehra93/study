...
class Test50{
    public static void main(String... args) throws InterruptedException{
        ...
        Runnable adder = ()->{System.out.println("adding");for(int i=0;i<1000;i++){foodData.add(1);foodData.add(2);foodData.add(3);}};
        Runnable remover = ()->{System.out.println("removing");for(int i=0;i<1000;i++)foodData.remove(1);};
        Runnable printer = ()->{
            for(int i=0;i<100;i++){
                for(var el:foodData){
