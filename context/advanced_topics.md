...
| AT07 | High | Prefix-state frequency counting | Install | Install exact-sum/remainder counting on a pool-safe representative, require independent recall, then re-screen held candidate `G12` for novelty and time fit. |
