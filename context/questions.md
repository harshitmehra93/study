...
| 89 | Intervals | 🟡 |  | Minimum Number of Arrows to Burst Balloons | Independent ownership is not established; load the matching history section after selection. |
...
| 91 | Greedy | 🟡 |  | Jump Game | Independent ownership is not established; load the matching history section after selection. |
...
| 103 | Stack | 🟡 |  | Online Stock Span | Independent ownership is not established; load the matching history section after selection. |
| 104 | Linked List | ✅ |  | Reverse Linked List | Learned; first verified recall is not yet recorded. |
...
| 116 | Binary Search | ✅ |  | Binary Search | Learned; first verified recall is not yet recorded. |
